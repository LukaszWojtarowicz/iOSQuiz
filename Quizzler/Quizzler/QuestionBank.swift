...
class QuestionBank {
    var list = [Question]() // we defined list/array and it's type of data
    
    init(){
        // Creating a quiz item and appending it to the list
        let item = Question(text: "Is Valentine\'s day is banned in Saudi Arabia?", correctAnswer: true)
        
        // Add the Question to the list of questions
        list.append(item)
        
        // both ways of creating of question do the same, but the second one is faster
        // so we  skip one step and just creat the quiz item inside the append function
